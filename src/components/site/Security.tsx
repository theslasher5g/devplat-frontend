    ...
    <main>
      <section className="border-b hairline dotgrid">
        <div className="mx-auto max-w-6xl px-5 py-20">
          ...
          <h1 className="text-4xl md:text-6xl font-semibold tracking-tight leading-[1.05] max-w-[26ch]">
      ...
      <section className="border-b hairline">
        <div className="mx-auto max-w-6xl px-5 py-20">
          <div className="grid gap-px bg-[--line] border hairline md:grid-cols-2 lg:grid-cols-3">
            {[
